...
class PNFW_Admin_Settings {
 public static function output() { ?>
  ...
  else if (isset($_POST['issubmitted_fire_os_tab']) && $_POST['issubmitted_fire_os_tab'] == 'yes') {
   PNFW_Admin_Settings::save_fire_os_options();
  }
   ...
   <div class="has-sidebar sm-padded">
    <div class="meta-box-sortabless">
     ...
     <h2 class="nav-tab-wrapper">
      ...
      <a href="?page=pnfw-settings-identifier&tab=fire_os_tab" class="nav-tab <?php echo $active_tab == 'fire_os_tab' ? 'nav-tab-active' : ''; ?>"><?php _e('Fire OS', 'push-notifications-for-wp'); ?> (<?php _e('Deprecated', 'push-notifications-for-wp'); ?>)</a>
     ...
     <form action="" method="post">
      <?php if ($active_tab == 'general_tab') {
       ...
       PNFW_Admin_Settings::print_android_advanced_box($pnfw_add_message_field_in_payload);
      ...
      else if ($active_tab == 'fire_os_tab') {
       PNFW_Admin_Settings::print_fire_os_box($pnfw_kindle_push_notifications, $pnfw_adm_client_id, $pnfw_adm_client_secret);

       PNFW_Admin_Settings::print_save_button('issubmitted_fire_os_tab');
      }
 ...
 private static function save_fire_os_options() {
  ...
  $pnfw_adm_client_id = pnfw_get_post('pnfw_adm_client_id');
  update_option('pnfw_adm_client_id', $pnfw_adm_client_id);

  $pnfw_adm_client_secret = pnfw_get_post('pnfw_adm_client_secret');
 ...
 private static function print_android_advanced_box($pnfw_add_message_field_in_payload) { ?>
  <!-- postbox -->
  <div class="postbox">
   <div class="inside">
    <h3 class="hndle">
  ...
  <!-- //-postbox -->
 <?php }
 private static function print_fire_os_box($pnfw_kindle_push_notifications, $pnfw_adm_client_id, $pnfw_adm_client_secret) { ?>
  <!-- postbox -->
  <div class="postbox">
   <div class="inside">
    <p>
     <input type="checkbox" name="pnfw_kindle_push_notifications" id="pnfw_kindle_push_notifications" <?php checked((bool)$pnfw_kindle_push_notifications) ?> /> <label for="pnfw_kindle_push_notifications"><?php _e('Send push notifications to Kindle Fire devices', 'push-notifications-for-wp'); ?></label>
    </p>
